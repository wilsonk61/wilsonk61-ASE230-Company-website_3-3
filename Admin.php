...
<body data-bs-theme="light">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav navbar-center" id="navbar-navlist">
                    ...
                    <li class="nav-item">
                        <a data-scroll href="#" class="nav-link">Admin</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <!-- START SIDEBAR -->
    <div class="sidebar">
        <h5>Admin Edit Home</h5>
		<a href="Admin.php">Admin Home</a>
		<a href="Admin/pages/index.php">Pages</a>
        <a href="Admin/team/index.php">Team</a>
        <a href="Admin/awards/index.php">Awards</a>
        <a href="Admin/products/index.php">Products</a>
        <a href="Admin/contacts/index.php">Contacts</a>
    </div>
    <!-- END SIDEBAR -->
